...
create table tf_tickets (
  ...
  , constraint fk_tickets_assignee foreign key (assignee_id) references core_users(user_id)
...
create index idx_tf_tickets_assignee on tf_tickets(assignee_id);
...
begin
  ...
  execute immediate 'comment on column tf_tickets.assignee_id is ''User assigned to the ticket.''';
